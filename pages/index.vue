      ...
      <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
        <div v-for="module of filteredModules" :key="module.name" class="relative flex flex-col bg-white shadow rounded-md overflow-hidden hover:shadow-lg">
          ...
          <div class="border-t border-gray-200 bg-gray-100 grid grid-cols-3">
            <a :href="npmUrl(module)" aria-label="npm" target=" _blank" rel="noopener" class="stats-block group flex items-center space-x-2 border-r border-gray-200 py-3 px-4 pl-6">
            ...
            <a :href="module.github" aria-label="stars" target=" _blank" rel="noopener" class="stats-block group flex items-center space-x-1 py-3 px-4 border-r border-gray-200">
            ...
            <div class="stats-block group flex items-center space-x-1 py-3 px-4 z-0 overflow-hidden">
